(() => {
  ...
  // public/assets/js/account-update.js
  ...
  // public/assets/js/ticket/ticket-deleteEdit.js
  var markTicketAs = (el) => {
  ...
  // public/assets/js/ticket/ticket-comment.js
  var TicketComment = function(ticketId) {
  ...
  // public/assets/js/authentication/sign-out.js
  var logout = () => {
